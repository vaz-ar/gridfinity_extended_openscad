...
function calcDimensionWidth(width) = calcDimention(width, "width", gf_pitch);
function calcDimensionDepth(depth) = calcDimention(depth, "depth", gf_pitch);
function calcDimensionHeight(height) = calcDimention(height, "height", gf_zpitch);
